...
urlpatterns = [
    ...
    url('todo_type/(?P<pk>\d+)/(?P<type>[-\w]+)/$',views.todo_type,name='todo_type'),
    url('todo_del/(?P<pk>\d+)/(?P<type>[-\w]+)/$',views.todo_del,name='todo_del'),
    ...
    url('todo_suc/(?P<pk>\d+)/(?P<type>[-\w]+)/$',views.todo_suc,name='todo_suc'),
]